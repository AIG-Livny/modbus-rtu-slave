...
enum function_code {
    // Reading digital output states
    CMD_READ_COIL_STATUS=0x01,

    // Reading digital input states
    CMD_READ_INPUT_STATUS=0x02,

    // Reading measurands, meters, mean-values - Reading the device configuration
    CMD_READ_HOLDING_REGISTERS=0x03,

    // Write single register
    CMD_WRITE_SINGLE_REGISTER=0x06,

    // Setting / Simulating digital output states
    CMD_WRITE_MULTIPLE_COILS=0x0F,

    // Device configuration
    CMD_WRITE_MULTIPLE_REGISTERS=0x10,
